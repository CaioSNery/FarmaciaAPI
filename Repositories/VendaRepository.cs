...
namespace FarmaciaSOFT.Services
{
    public class VendaRepository : IVendaRepository
    {
        ...
        public VendaRepository(AppDbContext context, ISMSService smsService, IMapper mapper)
        {
            _context = context;
        ...
        public async Task<IEnumerable<Venda>> ListarVendasAsync(int Skip = 0, int Take = 25)
        {
